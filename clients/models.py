...
class Order(models.Model):
    ...
    shows = models.ManyToManyField('Entertainment', verbose_name='Բաղադրիչներ')
    # event
    ...
    budget_min = models.PositiveSmallIntegerField(verbose_name='նվազագույն բյուջե')
    budget_max = models.PositiveSmallIntegerField(verbose_name='առավելագույն բյուջե')
    ...
    real = models.BooleanField(default=False, verbose_name='Կայքը ներկայումս զուգահեռաբար փորձարկվում է ծրագրավորողների կողմից։ Ընտրեք համապատասխան տարբերակը կազմակերպիչ ընկերությանը փաստացի միջոցառման կազմակերպման հայտարարություն ներկայացնելու և կազմակերպիչների հետ կապվելու համար։', 
        choices=(
